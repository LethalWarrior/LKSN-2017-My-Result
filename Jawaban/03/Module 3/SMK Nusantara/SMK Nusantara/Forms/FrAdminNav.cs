...
namespace SMK_Nusantara.Forms
{
    public partial class FrAdminNav : Form
    {
        ...
        private void BtnMSChdeule_Click(object sender, EventArgs e)
        {
            FrManageSchedule schedule = new FrManageSchedule();
            schedule.Show();
        ...
        {
            FrFinalizeSchedule schedule = new FrFinalizeSchedule();
            schedule.Show();
        }

        private void BtnClass_Click(object sender, EventArgs e)
        {
            FrManageClass kelas = new FrManageClass();
            kelas.Show();
        }
    }
}
