...
namespace SMK_Nusantara.Forms
{
    ...
    {
        public FrStudentNav(Student student, User user)
        {
            InitializeComponent();
        ...
        {
            FrViewSchedule schedule = new FrViewSchedule(this.student);
            schedule.Show();
        }

        private void BtnViewScore_Click(object sender, EventArgs e)
        {
            FrViewScore score = new FrViewScore(this.student);
            score.Show();
        }

        private void BtnMessage_Click(object sender, EventArgs e)
        {
            FrMessageMenu Mmenu = new FrMessageMenu(this.user, this);
            Mmenu.Show();
            this.Hide();
        }
